...
//   const [position, setPositionState] = useState(progress.buffered);
//   //   custom states
...
//     console.log('pro', progress.position);
//     await TrackPlayer.seekTo(progress.position + 5.0);
//     setPositionState(progress.position + 5.0);
//   };

//   const skipBehind = async () => {
...
//           style={{width: '60%', height: '70%', borderRadius: 15}}
//         /> */}
//       </View>
//       <View
//         style={{
...
//             right: 13,
//           }}>
//           {(progress.duration - progress.buffered).toFixed(2)}
//         </Text>
//       </View>
...
//           alignSelf: 'center',
//         }}>
//         <TouchableOpacity onPress={skipBehind}>
...
//         </TouchableOpacity>
//         <TouchableOpacity onPress={skipAhead}>
//           <Ionicons name="play-skip-forward-outline" size={35} color="yellow" />
//         </TouchableOpacity>
//       </View>
//     </View>
